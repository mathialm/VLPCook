...
cd bootstap.pytorch/bootstrap

DATA_DIR=~/poisoning/ML_Poisoning/data/datasets/Recipe1M


CUDA_VISIBLE_DEVICES=0 python -m bootstrap.run -o options/vlpcook_clip_finetune.yaml \
--dataset.batch_size 100 \
--dataset.dir  $DATA_DIR/val  \
--exp.dir log_dir/exp_name \
--model.network.path_vocab $DATA_DIR/text/vocab_all.txt \
--model.network.path_ingrs /text/vocab.pkl \
