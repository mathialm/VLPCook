...
def main():
    ...
    mean_ingrs = Variable(model.cuda_tf()(mean_ingrs.unsqueeze(0)), requires_grad=False)
    mean_instrs = Variable(model.cuda_tf()(mean_instrs.unsqueeze(0)), requires_grad=False)
